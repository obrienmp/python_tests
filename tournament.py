...
def playerStandings():
    ...
    """
    db, cur = connect()
    cur.execute("SELECT a.player_id, a.name, b.wins, c.matches FROM players",
                ' a LEFT JOIN wins_record b ON a.player_id = b.player_id ',
                'LEFT JOIN matches_played c ON a.player_id = c.player_id ',
                'GROUP BY a.player_id, a.name, b.wins, c.matches ORDER BY ',
                "b.wins DESC;")
